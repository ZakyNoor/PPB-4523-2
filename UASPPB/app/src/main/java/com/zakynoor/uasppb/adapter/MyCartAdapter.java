...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.MyCartViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyCartViewHolder holder, int position) {
        ...
        holder.textPrice.setText(new StringBuilder("Rp. ").append(cartModelList.get(position).getPrice()));
        holder.textName.setText((new StringBuilder().append(cartModelList.get(position).getName())));
        ...
        holder.btnDelete.setOnClickListener(v -> {
            AlertDialog dialog = new AlertDialog.Builder(context)
                    .setTitle("Hapus")
                    .setMessage("Yakin?")
                    .setNegativeButton("Batalkan", (dialog1, which) -> dialog1.dismiss())
